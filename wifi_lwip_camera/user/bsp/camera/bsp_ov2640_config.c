     ...
     case JPEG_640x480:
        {
            ...
            {
                OV2640_WriteReg(LPI2C1,OV2640_640x480_JPEG[i][0], OV2640_640x480_JPEG[i][1]);
            }
            break;
        }
     ...
     case JPEG_800x600:
        {
            ...
            {
                OV2640_WriteReg(LPI2C1,OV2640_800x600_JPEG[i][0], OV2640_800x600_JPEG[i][1]);
            }
            break;
        }
     case JPEG_1024x768:
        {
            ...
            {
                OV2640_WriteReg(LPI2C1,OV2640_1024x768_JPEG[i][0], OV2640_1024x768_JPEG[i][1]);
            }
            break;
        }
     default:
