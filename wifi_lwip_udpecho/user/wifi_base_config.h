...
#define IP_ADDR              MAKE_IPV4_ADDRESS( 192, 168,   31,  128 )  /* 如果USE_DHCP为WICED_TRUE，则不需要 */
#define GW_ADDR              MAKE_IPV4_ADDRESS( 192, 168,   31,   1 )   /* 如果USE_DHCP为WICED_TRUE，则不需要 */
